...
在完成对`picker.js`文件中相关函数的模拟实现后（具体代码见`picker.test.js`文件），对每个函数的使用的正常功能作相关的检测。
...
describe('Picker Page', function() {
  ...
  //验证picker函数使用的array的索引范围是否与预期相同  
...
<img src="E:\大三\软件工程\红潮日记\05-06版本\Crimson-Diary\测试相关内容\测试文档内容图片\picker_test.png" style="zoom:50%;" />
